...
from bases.base_stack import BaseStack
...
class Converter:
    ...
    def from_base_ten(self, number: Union[str, int], base: int) -> str:
        ...
        while True:
            if number < base:
                ...
                # stack
                stack.push(self.num_to_letters.get(number, number))
                break
            else:
                ...
                # letter and push to the stack else push the remainder to the
                # stack
                stack.push(self.num_to_letters.get(remainder, remainder))
    ...
    def to_base_ten(self, number: Union[str, int], base) -> str:
        ...
        for i in range(len(number) - 1, -1, -1):
            ...
            result += int(self.letters_to_num.get(number[i], number[i])) * base ** i
    ...
    def _decimal_to_base_ten(self, number: str, base: int) -> str:
        ...
        for i in range(0, len(number)):
            ...
            result += int(self.letters_to_num.get(current_char, current_char)) * (base ** -(i + 1))
    ...
    def _decimal_from_base_ten(self, number: str, base: int) -> str:
        ...
        while True:
            ...
            # letter and push to the stack else push the remainder to the
            # stack
            stack.push(self.num_to_letters.get(whole, whole))
